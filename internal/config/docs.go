...
var Sections = []Section{
	...
	},
	{
		...
		Keys: []Doc{
			{Key: "web.brave_api_key", Comment: "Where the Brave Search key comes from.", Example: `"cache:BRAVE_API_KEY"`},
			{Key: "web.exa_api_key", Comment: "Where the Exa key comes from; Exa answers when Brave cannot.", Example: `"cache:EXA_API_KEY"`},
